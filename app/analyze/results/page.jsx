...
export default function AnalysisResults() {
  ...
  const getRecommendation = () => {
    ...
    if (avgScore < 40) {
      return { type: 'Tech Platform', score: 85, reason: 'Strong cost focus across stakeholders suggests tech-enabled platform with lower overhead.', approach: 'Self-service platform with automated workflows' };
    } else if (avgScore > 60) {
      return { type: 'Traditional Broker', score: 82, reason: 'High service and support needs indicate traditional full-service broker is best fit.', approach: 'Dedicated broker with hands-on strategic consulting' };
    } else {
      return { type: 'Hybrid Approach', score: 79, reason: 'Mixed priorities suggest hybrid model combining tech efficiency with broker expertise.', approach: 'Tech platform with broker advisory services' };
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="bg-green-900/30 border border-green-500/50 rounded-xl p-6 mb-8 flex items-center gap-4">
          ...
          <div>
            <h3 className="text-xl font-bold">Strategic Recommendation Ready!</h3>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <a href="https://calendly.com/dbrazavi" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-blue-400 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white text-center font-bold py-4 rounded-lg transition shadow-lg">
            Book Strategy Call
          </a>
          <a href="/surveys/employer" className="bg-slate-700 hover:bg-slate-600 text-white text-center font-bold py-4 rounded-lg transition">
